...
import PbearWinnings from './PbearWinnings'
...
const FarmedStakingCard = () => {
  ...
  const [onPresentBuy] = useModal(<BuyModal max={cakeBalance} tokenName="PBEAR" />)
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <Block>
          <PbearWinnings />
          <Label>{TranslateString(552, 'PBEAR to Collect')}</Label>
        </Block>
        <Block>
          <LotteryJackpot />
