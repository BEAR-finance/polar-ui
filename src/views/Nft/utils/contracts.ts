...
import { RABBIT_MINTING_FARM_ADDRESS, PANPBEAR_RABBITS_ADDRESS } from 'config/constants/nfts'
...
export const getPancakeRabbitContract = (contractOptions?: ContractOptions) => {
  ...
  return getContract(pancakeRabbitsAbi, PANPBEAR_RABBITS_ADDRESS, contractOptions)
}
